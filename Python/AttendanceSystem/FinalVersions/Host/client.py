...
def show_camera():
    global text, frame_counter, status
            ...
            while True:
                ...
                if ret_val:
                    ...
                    if ready_to_read:
                        ...
                        if split_input[0] == "E":
                            text = "Name: " + split_input[1]
                            curent_time = datetime.now().strftime('%H:%M:%S')
                            status = "Entry Time: " + curent_time
                            print(text)
                        if split_input[0] == "L":
                            text = "Name: " + split_input[1]
                            curent_time = datetime.now().strftime('%H:%M:%S')
                            status = "Leave Time: " + curent_time
                            print(text)
                    ...
                    cv2.putText(processed_frame, status, (20, 40), font, 0.5, (255, 255, 255), 1)
                    frame_counter += 1
