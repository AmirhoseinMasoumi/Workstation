...
int main(void)
{
  ...
  while (1)
  {
		...
		MPU6050_Get_Accel_Cali(&myAccelCali);
		...
		if(count < 10){
			...
			if(halfPress == 2){
				...
				char temp[10];
				int c= snprintf(temp, sizeof(temp),"%d\n", pressCount);
